...
const Links = [
  { name: 'NOS PRODUITS', route: '/products' },
  { name: 'HISTOIRE', route: '/histoire' },
  { name: 'RECETTES', route: '/recette' },
...
const Header = () => {
  ...
  return (
    <>
      <Box bg={mode(`white`, 'gray.900')} px="4">
      ...
      {userInfo && !userInfo.active && showBanner && (
        <Box>
          <Alert status="warning">
            <AlertIcon />
            <AlertTitle>E-mail non vérifié!</AlertTitle>
            <AlertDescription>Vous devez vérifier votre adresse e-mail.</AlertDescription>
            <Spacer />
